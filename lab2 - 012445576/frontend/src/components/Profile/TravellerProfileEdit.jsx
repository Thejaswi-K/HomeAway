...
class TravellerprofileEdit extends Component {
    constructor(props) {
        ...
        this.profileUploadHandler=this.profileUploadHandler.bind(this);  
    }
    logout = (e) => {
    ...
    editHandler = (e) => {
        ...
        //   formData.append('PP', profileimage);
        //   console.log(formData)
        //   axios.post('http://localhost:3001/uploadpp', formData)
        //   .then((result) => {
           
            console.log("profileimage data",data.profileimage)
                            ...
                            <div className="input-group mb-3">
                                ...
                                <div className="custom-file">
                                    <input
                                        ...
                                        id="photos upload"
                                        name="photoimage"
                                        onClick={this.profileUploadHandler}
                                    />
                                </div>
                            </div>
                        </div>
